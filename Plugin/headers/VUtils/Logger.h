...
class Logger {
public:
  static void create(const std::string& output, PrintType type = PrintType::LOG);
  static void create(const std::string& output, const char* file, const char* func, PrintType type = PrintType::LOG);
