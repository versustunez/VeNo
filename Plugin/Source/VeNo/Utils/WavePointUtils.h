...
struct WavePoint {
  ...
  static bool removeCurrentPoint(Audio::WaveUIPoints &points,
                                 Utils::WavePoints &currentPoint);
  ...
  static void interpolateWave(Audio::WaveTableLib *waveLib, size_t first,
