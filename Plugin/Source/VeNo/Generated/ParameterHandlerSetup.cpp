...
void ParameterHandler::setupParameter() {
  ...
  for (int i = 1; i < 5; i++) {
    ...
    addParameterModulate(oscId + "detune_dense", OSCName + " Detune Strength",
                         0, 150, 0, Float);
    addParameter(oscId + "detune_mode", OSCName + " Detune Mode", 1, 4, 2,
                 Integer);
  ...
  for (int i = 1; i < 3; i++) {
    ...
    addParameter(lfoId + "wave_position", LFOName + " Waveform Position", 0, 1,
                 0, Float);
  }
  ...
  for (int i = 1; i < 3; i++) {
    ...
    addParameterModulate(rngId + "change_rate", RandomName + " Change Rate", 16,
                         4096, 256, Integer);
    addParameterModulate(rngId + "mode", RandomName + " Mode", 1, 2, 1,
                         Integer);
  }
