...
namespace VeNo::GUI
{
void Flex::setItems (std::vector<std::shared_ptr<BaseComponent>>& components, std::vector<std::shared_ptr<ComponentGroup>>& groups)
{
    for (auto& component : components)
    {
        auto& pos = component->pos;
        m_flexBox.items.add (juce::FlexItem (*component).withMinWidth (pos.w).withMinHeight (pos.h));
    }
