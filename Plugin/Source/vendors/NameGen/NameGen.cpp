...
Generator::Generator (std::vector<std::unique_ptr<Generator>>&& generators_) : generators (std::move (generators_))
{
}
...
Random::Random (std::vector<std::unique_ptr<Generator>>&& generators_) : Generator (std::move (generators_))
{
}
...
Sequence::Sequence (std::vector<std::unique_ptr<Generator>>&& generators_) : Generator (std::move (generators_))
{
}

Literal::Literal (const std::string& value_) : value (value_)
{
}
...
Generator::Group::Group (group_types_t type_) : type (type_)
{
}
...
Generator::GroupSymbol::GroupSymbol() : Group (group_types::symbol)
{
}
...
Generator::GroupLiteral::GroupLiteral() : Group (group_types::literal)
{
}
